...
class TeleopControl(object):
    ...
    def setup_pubsub(self):
        ...
        self.vel_raw_pub = rospy.Publisher('/mavros/setpoint_velocity/cmd_vel_unstamped', Twist, queue_size=10)
    ...
    def cmd_vel_cb(self, data: Twist):
        print("Publishing cmd vel to mavros!", data)
        self.vel_raw_pub.publish(data)
